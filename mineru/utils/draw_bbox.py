...
def draw_layout_bbox(pdf_info, pdf_bytes, out_path, filename):
    ...
    for page in pdf_info:
        ...
        for block in page["para_blocks"]:
            ...
            # 化学式
            elif block["type"] == BlockType.CHEMICAL:
                chemicals.append(bbox)
    ...
    for i, page in enumerate(pdf_docs.pages):
        ...
        c = draw_bbox_without_number(i, chemicals_list, page, c, [0, 255, 255], True)
...
def draw_span_bbox(pdf_info, pdf_bytes, out_path, filename):
    ...
    def get_span_info(span):
        ...
        elif span['type'] == ContentType.CHEMICAL_FORMULA:
            page_chemical_list.append(span['bbox'])
    ...
    for page in pdf_info:
        ...
        chemical_list.append(page_chemical_list)
    ...
    for i, page in enumerate(pdf_docs.pages):
        ...
        draw_bbox_without_number(i, chemical_list, page, c, [0, 255, 255], False)
