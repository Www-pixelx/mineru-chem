...
def get_chem_enable(chem_enable):
    chem_enable_env = os.getenv('MINERU_CHEM_ENABLE')
    chem_enable = chem_enable if chem_enable_env is None else chem_enable_env.lower() == 'true'
    return chem_enable
