...
def _process_pipeline(
    ...
    infer_results, all_image_lists, all_pdf_docs, lang_list, ocr_enabled_list = (
        pipeline_doc_analyze(
            ...
            formula_enable=p_formula_enable, chem_enable=p_chem_enable, table_enable=p_table_enable
        )
    )
    ...
    for idx, model_list in enumerate(infer_results):
        ...
        middle_json = pipeline_result_to_middle_json(
            ...
            _lang, _ocr_enable, p_formula_enable, p_chem_enable
        )
...
def do_parse(
    ...
    if backend == "pipeline":
        _process_pipeline(
            ...
            parse_method, formula_enable, chem_enable, table_enable,
